...
import file from "../day12/source_12.txt";
import testFile from "../day12/test_12.txt"
import testSmall from "../day12/test_small.txt"
import testLarger from "../day12/test_larger.txt"
...
export const exercise_23 = async () => {
    fetch(file)
        .then( r => r.text() )
        .then( t => {
            let pathsLines = t.split('\n');
            pathsLines = pathsLines.map( x => {
